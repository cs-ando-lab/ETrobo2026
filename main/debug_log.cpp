...
void debug_log_init(const debug_sensors_t *sensors) {
    if (sensors->color) sensors->color->lightOn();
...
void debug_log_all(const debug_sensors_t *sensors, int count) {
    ...
    case 0: {
        ...
        if (rgb.r != pr || rgb.g != pg || rgb.b != pb || refl != prefl) {
            ...
            pr = rgb.r; pg = rgb.g; pb = rgb.b; prefl = refl;
        }
        break;
    }
    case 1: {
        ...
        if (approxColor.h != pah || approxColor.s != pas || approxColor.v != pav) {
            ...
            pah = approxColor.h; pas = approxColor.s; pav = approxColor.v;
        }
        break;
    }
    case 2: {
    ...
    case 3: {
        ...
        if (lpow != plp || rpow != prp || lstall != plst || rstall != prst) {
            ...
            plp = lpow; prp = rpow; plst = lstall; prst = rstall;
        }
        break;
    }
    case 4: {
        ...
        if (heading != ph || ax != pax || ay != pay || az != paz) {
            ...
            ph = heading; pax = ax; pay = ay; paz = az;
        }
        break;
    }
    case 5: {
    ...
    case 7: {
        ...
        if (touched != pt || force_x100 != pf || dist_x100 != pdst) {
            ...
            pt = touched; pf = force_x100; pdst = dist_x100;
        }
        break;
    }
    case 8: {
        ...
        if (left != pl || center != pc2 || right != pr2 || bt != pbt) {
            ...
            pl = left; pc2 = center; pr2 = right; pbt = bt;
        }
        break;
    }
    }
